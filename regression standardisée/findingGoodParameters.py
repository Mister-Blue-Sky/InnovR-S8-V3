...
print(Ar2s[besti],Ar2sUVG[besti])
...
# fig = go.Figure(px.scatter_3d(log_x=True,log_y=True, title="R2-CTC and R2_UVG depending on alpha and maxIter"))
# fig.add_scatter3d(name="R2_CTC",x=Aalphas,y=Aiter,z=r2s,mode="markers")
# fig.add_scatter3d(name="R2_UVG",x=Aalphas,y=Aiter,z=r2sUVG,mode="markers")
